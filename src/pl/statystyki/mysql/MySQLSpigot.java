...
import pl.statystyki.shared.config.ConfigSpigot;

public class MySQLSpigot {
	
	YamlConfiguration config = ConfigSpigot.loadConfig();
	...
	public MySQLSpigot(String host, String database, String user, String password) {
		this.HOST = host;
